...
IX_path = '/content/new_cnn/img/00069_A.jpg'
IY_path = '/content/new_cnn/img/00069_B.jpg'
...
cv2.imwrite("reference.png", cv2.cvtColor(IX, cv2.COLOR_BGR2RGB))
plt.subplot(132)
plt.title('registered')
plt.imshow(cv2.cvtColor(registered, cv2.COLOR_BGR2RGB))
cv2.imwrite("registered.png", cv2.cvtColor(registered, cv2.COLOR_BGR2RGB))
plt.subplot(133)
plt.title('checkboard')
plt.imshow(cv2.cvtColor(cb, cv2.COLOR_BGR2RGB))
cv2.imwrite("cb.png", cv2.cvtColor(cb, cv2.COLOR_BGR2RGB))
